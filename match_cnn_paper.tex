...
\ac{CNN}~\cite{726791}. The layers of such a network are composed of different
types. The input layer holds the raw pixel values of the sample image which, in
our case, is a 1-dimensional timeseries vector. As the data is 1-dimensional,
the weight and bias parameters of the network are also in 1-dimensional vector
...
information. Finally we have a hidden layer connected to an output layer which
