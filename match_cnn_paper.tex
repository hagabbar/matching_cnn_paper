...
%
Matched filtering uses a \textit{bank} of template waveforms that span
...
~\fergus{Tom suggests citing: \cite{1705.01845,PhysRevD.90.082004,PhysRevD.89.024003,PhysRevD.89.084041,PhysRevD.86.084017}.} 
...
use in a matched-filtering approach.  You should also mention that the correct density 
...
phase and distance. By first defining the noise weighted inner
...
%
After tuning several hyperparameters and then settling on
